...
<head>
    ...
    <body>
                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="{{ route('all.post') }}" class="btn-box big span4"><i class=" icon-random"></i><b>{{$countPost}}</b>
                                        <p class="text-muted">
                                            Posts</p>
                                    </a><a href="{{ route('all.user') }}" class="btn-box big span4"><i class="icon-user"></i><b>{{$countUser}}</b>
                                        <p class="text-muted">
                                            Users</p>
                                    </a>
        ...
        <script src=" {{ asset('adminDash/scripts/flot/jquery.flot.js') }} " type="text/javascript"></script>
        <script src=" {{ asset('adminDash/scripts/flot/jquery.flot.resize.js') }} " type="text/javascript"></script>
        <script src=" {{ asset('adminDash/scripts/datatables/jquery.dataTables.js') }} " type="text/javascript"></script>
        <script src=" {{ asset('adminDash/scripts/common.js') }} " type="text/javascript"></script>
